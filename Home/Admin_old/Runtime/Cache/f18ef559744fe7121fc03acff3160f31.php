...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(__STATICS__/images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">添加父菜单 </SPAN><SPAN 
    ...
    vAlign=top align=middle>
      ...
      border=1>
              <TBODY>
               <TR>
                  <TH colspan="2" class=gridViewHeader style="WIDTH: 50px" scope=col style="width:330px"><font color="red">添加菜单</font></TH>
               </TR>
               <?php if($parent_menu): ?><tr>
               		<th><if condition="$parent_menu">父菜单：</th>
               		<th><input type="text" value="<?php echo ($parent_menu); ?>"/></th>
               </tr><?php endif; ?>
               <tr>
               		<td class=gridViewItem>菜单名:</td>
               		<td class=gridViewItem><input type="text" name="menu"/></td>
               </tr>
               <tr>
                ...
                <tr>
               		...
               		<td class=gridViewItem><textarea id="editor_id" name="text" style="width:100%;height:500px;"></textarea></td>
               </tr>
                 <tr>
