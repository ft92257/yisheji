...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(__STATICS__/images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">添加公司 </SPAN><SPAN 
      ...
      border=1>
              <TBODY>
                <TR>
                  ...
                  <TH class=gridViewHeader scope=col>输入密码</TH>
                  <TH class=gridViewHeader scope=col>确认密码</TH>  
                  <TH class=gridViewHeader scope=col>确认提交</TH>                
                </TR>
                <form method="post">
				<tr>
					 <td class=gridViewItem><input id="t" type="text" name="account"/></td>
				     <td class=gridViewItem><input type="text" name="name"/></td>
