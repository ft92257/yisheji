    ...
    vAlign=top align=middle>
      ...
      border=1><form method = "post" >
                ...
                <TR>
                  ...
                  <th class=gridViewHeader scope=col style="WIDTH: 80px">样板房Id</td>
                  <th class=gridViewHeader scope=col>样板房名称</td> 
                  ...
                  <th class=gridViewHeader scope=col>设计费用</td> 
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
					     ...
					     <td class=gridViewItem><?php echo ($vo["design_fee"]); ?></td>
