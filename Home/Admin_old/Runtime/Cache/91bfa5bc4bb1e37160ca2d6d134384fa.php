...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(__STATICS__/admin/images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">更新公司 </SPAN><SPAN 
    ...
    vAlign=top align=middle>
      ...
      border=1>
              <TBODY>
                <TR>
                  <TH class=gridViewHeader scope=col>公司账号</TH>
                  <TH class=gridViewHeader scope=col>公司名称</TH>
                  <TH class=gridViewHeader scope=col>更新密码</TH>
                  <TH class=gridViewHeader scope=col>确认密码</TH>  
                  <TH class=gridViewHeader scope=col>确认提交</TH>                
                </TR>
                <form method="post">
				<tr>
					 <td class=gridViewItem>公司账号: <?php echo ($manager["account"]); ?></td>
				     <td class=gridViewItem><input type="text" name="name" value="<?php echo ($company["name"]); ?>" /></td>
				     <td class=gridViewItem><input type="password" name="password" /></td>
				     <td class=gridViewItem><input type="password" name="repassword" /></td>
				     <td class=gridViewItem> <input type="submit" value="提交" style="cursor:pointer" onmouseover="this.style.backgroundColor='#FF0000'" onmouseout="this.style.backgroundColor='#cccccc'"/></form></td>
				</tr></form>
</body>
</html>