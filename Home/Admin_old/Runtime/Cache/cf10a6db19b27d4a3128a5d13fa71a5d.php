...
<DIV>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(__STATICS__/images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">装修公司列表 </SPAN><SPAN 
    ...
    vAlign=top align=middle>
      ...
      border=1>
              <TBODY>
                <TR>
                  ...
                  <TH class=gridViewHeader scope=col>公司Id</TH>
                  <TH class=gridViewHeader scope=col>公司名称</TH>
                  <TH class=gridViewHeader scope=col>注册时间</TH>
                  <TH class=gridViewHeader scope=col>更新公司</TH>               
                </TR>
     ...
     <td class=gridViewItem> <a class=cmdField href="<?php echo U('/Manager/update/id/');?>/<?php echo ($vo["id"]); ?>">&nbsp;修改&nbsp;</a></td>
