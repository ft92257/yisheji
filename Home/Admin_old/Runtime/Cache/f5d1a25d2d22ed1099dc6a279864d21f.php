    ...
    vAlign=top align=middle>
      ...
      border=1>
                ...
                <TR>
                  ...
                  <th class=gridViewHeader scope=col style="WIDTH: 80px">活动Id</td>
                  <th class=gridViewHeader scope=col>活动标题</td> 
                  <th class=gridViewHeader scope=col>主办方</td>
                  <th class=gridViewHeader scope=col>详细地址</td>
                  <th class=gridViewHeader scope=col>开始日期</td>
                  <th class=gridViewHeader scope=col>结束日期</td>
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
					     ...
					     <td class=gridViewItem><?php echo ($vo["title"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["organizer"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["address"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["begin_date"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["end_date"]); ?></td>
