    ...
    vAlign=top align=middle>
      ...
      border=1>
                <TR>
                  ...
                  <th class=gridViewHeader scope=col>举报对象</td>
                  <th class=gridViewHeader scope=col>举报类型</td>
                  <th class=gridViewHeader scope=col>举报理由</td>
                  <th class=gridViewHeader scope=col>电话号码</td>
                  <th class=gridViewHeader scope=col>通过审核</td>
                ...
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
					     ...
					     <td class=gridViewItem><?php echo ($vo["reason"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["telephone"]); ?></td>
					     <?php if($vo["status"] == 0): ?><td class=gridViewItem><a href="<?php echo U('/Report/update/id');?>/<?php echo ($vo["id"]); ?>" style="color:red">取消通过</a></td><?php else: ?>
     					 <td class=gridViewItem><a href="<?php echo U('/Report/update/id');?>/<?php echo ($vo["id"]); ?>">通过审核</a></td><?php endif; ?>
