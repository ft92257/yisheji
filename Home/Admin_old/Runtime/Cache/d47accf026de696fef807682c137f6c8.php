    ...
    vAlign=top align=middle>
      ...
      border=1>
                <TR>
                  ...
                  <th class=gridViewHeader scope=col style="WIDTH: 80px">用户Id</td>
                  <th class=gridViewHeader scope=col>用户名</td>
                  <th class=gridViewHeader scope=col>用户类型</td>
                  <th class=gridViewHeader scope=col>手机号码</td>
                  <th class=gridViewHeader scope=col>扣款金额</td>
                  <th class=gridViewHeader scope=col>预约时间</td>
                  <th class=gridViewHeader scope=col>扣款时间</td>
                  <th class=gridViewHeader scope=col>是否扣款</td>
                  <th class=gridViewHeader scope=col>留言信息</td>
                   <th class=gridViewHeader scope=col>是否处理</td>
                ...
                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
					     ...
					     <td class=gridViewItem><?php echo ($vo["telephone"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["money"]); ?></td>
					     <td class=gridViewItem><?php echo (date('Y-m-d H:i:s',$vo["expect_time"])); ?></td>
					     <td class=gridViewItem><?php echo (date('Y-m-d H:i:s',$vo["charge_time"])); ?></td>
					     <td class=gridViewItem><?php echo ($vo["charged"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["message"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["handle"]); ?></td>
