  ...
  height=47>
    ...
    vAlign=top align=middle>
      ...
      border=1><form method = "post" >
					...
					<tr><td>按用户名查询:</td><td ><input type = "text" name = "nickname"/></td></tr>
                ...
                <TR>
                  ...
                  <th class=gridViewHeader scope=col>评论Id</td>
                  <th class=gridViewHeader scope=col>评论类型1公司2施工队3样板房</td>
                ...
                </TR><?php if($data): if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
				...
				<?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
					  	 <TD class=gridViewItem style="WIDTH: 50px"><IMG src="__STATICS__/admin/index/EmployeeMgr/bg_users.gif">
					     <td class=gridViewItem><?php echo ($vo["id"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["type"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["uid"]); ?></td>
					     <td class=gridViewItem><?php echo ($vo["score"]); ?></td>
