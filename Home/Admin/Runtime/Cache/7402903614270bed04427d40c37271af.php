...
<div class="right">
	...
	<div class="b frame">
		...
		<div class="menus">
		父菜单&nbsp;&nbsp;&nbsp;&nbsp;<?php if(is_array($parent_menus)): foreach($parent_menus as $key=>$pm): ?><a href="<?php echo ($pm["href"]); ?>" class="<?php echo ($pm["current"]); ?>"><?php echo ($pm["menu"]); ?>&nbsp;&nbsp;|&nbsp;&nbsp;</a><?php endforeach; endif; ?>
		<a href="<?php echo U('add');?>">+添加</a><br>
		子菜单&nbsp;&nbsp;&nbsp;&nbsp;<?php if(is_array($menus)): foreach($menus as $key=>$mu): ?><a href="<?php echo ($mu["href"]); ?>" class="<?php echo ($mu["current"]); ?>"><?php echo ($mu["menu"]); ?>&nbsp;&nbsp;|&nbsp;&nbsp;</a><?php endforeach; endif; ?>
		<a href="<?php echo ($addhref); ?>">+添加</a>
		</div>
