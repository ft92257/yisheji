      ...
      <div class="left">
        <div class="booking b">
          ...
          <ul>
            ...
            <li><a href="<?php echo U('Pay/list_pay');?>">预约款查询</a></li>
          </ul>
        </div>
        ...
        <div class="frame hide" id="menu2">
          ...
          <div class="">
            ...
            <h3>预付款明细</h3>
              ...
              <div class="link">
                <a href="<?php echo U('Pay/list_pay');?>">充值记录</a>
                扣款记录
              </div>
              <div class="Tevents">
                <table><!--全部明细-->
                  <tr><td>日期</td><td>金额</td><td>类别</td><td>订单号</td></tr>
                   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><?php echo (date("Y-m-d H:i:s",$vo["createtime"])); ?></td><td><?php echo ($vo["money"]); ?></td><td><?php echo ($t); ?></td><td><?php echo ($vo["id"]); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
                </table>
                <?php echo ($page); ?>
              </div>
          </div>
