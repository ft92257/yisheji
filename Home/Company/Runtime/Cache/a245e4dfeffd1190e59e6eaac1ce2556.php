    ...
    <div class="content" id="left_nav">
      ...
      <div class="right">
        <div class="frame hide" id="menu2">
          ...
          <div class="">
            <h3>设计师列表</h3>
				<p><a href="<?php echo U('Designer/add');?>">+添加设计师</a></p>
			
			  <div class="Tevents">
                <table width="100%">
                  <tr><td>编号</td><td>帐号</td><td>姓名</td><td>昵称</td><td>操作</td></tr>
                   <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  	<td><?php echo ($vo["uid"]); ?></td><td><?php echo ($vo["account"]); ?></td><td><?php echo ($vo["realname"]); ?></td><td><?php echo ($vo["nickname"]); ?></td>
				  	<td><a href="<?php echo U('/Designer/delete/uid');?>/<?php echo ($vo["uid"]); ?>" onclick="if(!confirm('确定删除该记录？')){return false;}">删除</a></td>
